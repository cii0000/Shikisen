...
## 概要
<img src="Rasen/Images/Readme0.png" alt="メモ" width="50%"> <img src="Rasen/Images/Readme1.png" alt="メモ全体" width="50%"> <img src="Rasen/Images/Readme2.png" alt="全体" width="50%">
...
<img src="Rasen/Images/Readme3.png" alt="ソフトウェア外見" width="50%"> <img src="Rasen/Images/Readme4.png" alt="アクション表示" width="50%">
...
<img src="Rasen/Images/Readme5.png" alt="ヒトコゴミ" width="50%"> <img src="Rasen/Images/Readme6.png" alt="ヒトコゴミ全体" width="50%">
...
<img src="Rasen/Images/Readme7.png" alt="スペクトログラムや計算式" width="50%">
...
　
<img src="Rasen/Images/Readme8.gif" alt="指し示しと範囲選択" width="50%">
...
<img src="Rasen/Images/Readme9.gif" alt="ズーミング" width="50%">
...
<img src="Rasen/Images/Readme10.gif" alt="バージョン選択" width="50%">
　このソフトウェアは常にオートセーブで、「範囲選択」の結果や「取り消し」も保存します。ほとんどのソフトウェアでは取り消しの後に何かを書き込んだことで消滅する「やり直し」もバージョンとして保存します。

<img src="Rasen/Images/Readme11.gif" alt="囲みカットとストローク" width="50%">
...
<img src="Rasen/Images/Readme12.gif" alt="配色と色の変更" width="50%">
...
<img src="Rasen/Images/Readme13.gif" alt="タイムラインと補間" width="50%">
...
　
<img src="Rasen/Images/Readme14.png" alt="楽譜" width="25%">
...
## 現在の問題点と今後の予定
　本ソフトウェアの改善要望やバグ修正要望は今のところ受け付けておりませんのでご了承ください。また、英語がよく分からないので、英語は自動翻訳でしか対応できません（ソースコード上では英単語を記号としてしか見ていません）。バージョンは1.0となっていますが気分でそう付けただけで、破壊的なアップデートが行われる可能性は十分あり、将来のバージョンでデータや操作の互換性が失われる可能性があります。特にアニメーションや音楽周りはまだ設計が未熟で安定していません。下記は主要な問題のリストです。
